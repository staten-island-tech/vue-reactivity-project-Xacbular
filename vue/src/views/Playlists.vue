<template>
  <main class="playlists-page">
    <section class="playlists-page__header">
      <div>
    ...
    <section v-if="!store.currentUser" class="playlists-page__empty">
    ...
    <section v-else-if="playlists.length === 0" class="playlists-page__empty">
    ...
    <section v-else class="playlists-page__grid">
      <article v-for="playlist in playlists" :key="playlist.id" class="playlists-page__card">
